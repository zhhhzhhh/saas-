...
import org.example.project.dao.entity.ShortLinkGotoDO;
...
import org.example.project.mq.producer.ShortLinkStatsSaveProducer;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    private final ShortLinkStatsSaveProducer shortLinkStatsSaveConsumer;
    ...
    public ShortLinkCreateRespDTO createShortLink(ShortLinkCreateReqDTO requestParam) {
        ...
        try {
            ...
            throw new ServiceException(String.format("短链接: %s 重复", fullShortUrl));
        }
        //缓存预热
    ...
    public void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        ...
        if (!Objects.equals(hasShortLinkDO.getValidDateType(), requestParam.getValidDateType())
            ...
            if (hasShortLinkDO.getValidDateType() != null && hasShortLinkDO.getValidDate().before(currentDate)) {
                //再将过期的短链接设置为有效时，将redis中跳转的空Key删除
    ...
    @Override
    public List<ShortLinkGroupCountQueryRespDTO> listGroupShortCount(List<String> requestParam) {
    ...
    public void restoreUrl(String shortUri, ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            ShortLinkGotoDO shortLinkGotoDO = shortLinkGotoMapper.selectOne(linkGotoQueryWrapper);
            if (shortLinkGotoDO == null) {//没有找到对应的gid
    ...
    public void shortLinkStats(ShortLinkStatsRecordDTO statsRecord) {
        ...
        shortLinkStatsSaveConsumer.send(produceMap);
    }
